...
class StratatoolsConsoleApp():
    ...
    def build_argparser(self):
        ...
        eeprom_create.add_argument("-D", "--diag-format", action="store_true", dest="diag_format", help="Produce output in the ASCII format used over the printer diagnostic port")
        eeprom_create.add_argument("-a", "--use-ascii", action="store_true", dest="use_ascii", help="Use ASCII format for output file")
        ...
        eeprom_create.add_argument("-D", "--diag-format", action="store_true", dest="diag_format", help="Read input in the ASCII format used over the printer diagnostic port")
